...
def run_inference_for_single_image(image, sess):
    ...
    if 'detection_masks' in tensor_dict:
        ...
        real_num_detection = tf.compat.v1.cast(tensor_dict['num_detections'][0], tf.int32)
        ...
        detection_masks_reframed = tf.compat.v1.cast(
            tf.compat.v1.greater(detection_masks_reframed, 0.5), tf.uint8)
...
def open_graph():
    ...
    with detection_graph.as_default():
        ...
        with tf.compat.v1.gfile.GFile('ssd_mobilenet_v1_coco_2017_11_17/frozen_inference_graph.pb', 'rb') as fid:
